...
import com.aquariux.crypto.domain.Employee;
import com.aquariux.crypto.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.aquariux.crypto.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
