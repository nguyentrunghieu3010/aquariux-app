...
import com.aquariux.crypto.domain.JobHistory;
import com.aquariux.crypto.repository.JobHistoryRepository;
import com.aquariux.crypto.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.aquariux.crypto.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<JobHistory> partialUpdateJobHistory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, jobHistory.getId().toString())
        );
    }
